...
public final class TestApplication {
	...
	private static final String EBAY_URL = "http://www.ebay.com/sch/i.html?_from=R40&_sacat=0&LH_Auction=1&_sop=1&LH_FS=1&_nkw="
			+ SEARCH_FOR
			+ "&_dcat=158671&rt=nc&_mPrRngCbx=1&_udlo&_udhi="
			+ PRICE_CEILING;
	...
	public static void main(String[] args) {
		HtmlParser parser = JSoupHtmlParser.createFor(getHTMLFromEbay("batman",
				"0.25"));
		System.out.println(JSoupHtmlParser.createFor(
				parser.getHTMLContentOfNthOccurance("ul", NTH_OCCURANCE))//
				.getHTMLContentOfFirst("li"));
	}

	private static String getHTMLFromEbay(String searchFor, String priceCeiling) {
		return getHTMLFrom(EBAY_URL.replace(SEARCH_FOR, searchFor).replace(
